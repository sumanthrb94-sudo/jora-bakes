  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <MetricCard title="Active Flux" value={orders.filter(o => !['delivered', 'cancelled', 'cancelled_and_refunded'].includes(o.status)).length} detail="2 New" trend="up" icon={<ShoppingBag size={20} />} color="bg-orange-500" />
