...
export const products: Product[] = [
  {
    ...
    images: ['/images/brownie.png', '/images/brownie_closeup.png'],
  ...
  },
  {
    ...
    bakeTime: 'Order 1 day prior for freshly baked delicacies',
    allergens: ['dairy', 'gluten'],
    images: ['/images/cheesecake.png', '/images/cheesecake_closeup.png'],
  ...
  },
  {
    ...
    bakeTime: 'Order 1 day prior for freshly baked delicacies',
    allergens: ['dairy', 'gluten'],
    images: ['/images/basque.png', '/images/basque_closeup.png'],
  ...
  },
  {
    ...
    bakeTime: 'Order 1 day prior for freshly baked delicacies',
    allergens: ['dairy', 'gluten'],
    images: ['/images/cupcakes.png', '/images/cupcakes_closeup.png'],
  ...
  },
  {
    ...
    bakeTime: 'Order 1 day prior for freshly baked delicacies',
    allergens: ['dairy', 'gluten'],
    images: ['/images/tiramisu.png', '/images/tiramisu_closeup.png'],
