              ...
              <div className="flex items-center gap-4 pt-2">
                <div className="flex items-center bg-gray-100 rounded-2xl px-2 py-2">
                  <button 
                    ...
                    className="w-10 h-10 flex items-center justify-center text-[var(--color-chocolate)] bg-white rounded-xl shadow-sm"
                  >
                    <Minus size={18} />
                  </button>
                ...
                <button 
                  ...
                  className="flex-1 bg-[var(--color-chocolate)] text-[var(--color-cream)] py-4 rounded-2xl font-bold text-lg shadow-lg hover:bg-opacity-90 transition-colors flex items-center justify-center gap-2"
                >
                  Treat Yourself • ₹{currentPrice * quantity}
                </button>
              </div>
            </div>
          </motion.div>
